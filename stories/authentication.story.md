...
#### Acceptance Criteria
- [ ] **AC1**: User can login with valid credentials (email/password)
- [ ] **AC2**: User cannot login with wrong password (shows error)
- [ ] **AC3**: User cannot login with non-existent email
- [ ] **AC4**: User is redirected to workspace after login

### G2: Role-Based Login
As an admin, I want different roles to have appropriate access after login.

#### Acceptance Criteria
- [ ] **AC1**: Owner can login and access all features
- [ ] **AC2**: Admin can login and access admin features
...
#### Acceptance Criteria
- [ ] **AC1**: Session persists across page reloads
- [ ] **AC2**: User can logout and session is cleared
...
#### Acceptance Criteria
- [ ] **AC1**: Empty fields show required error
- [ ] **AC2**: Invalid email format shows error
- [ ] **AC3**: Short password shows error
