...
ownerTest.describe('Navigation Overflow Menu', () => {
  ...
  // Note: Tests for navigation and active state from overflow menu are omitted
  // as they cause test isolation issues and are less critical for core functionality
});
